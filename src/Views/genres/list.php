...
<div class="container mt-5">
    <div class="card">
        ...
        <div class="card-body">
            <a href="/genres/create" class="btn btn-primary mb-3">Agregar Género</a>
            <table class="table table-striped table-hover">
                ...
                <tbody>
                    <?php foreach ($genres as $genre): ?>
                        <tr>
                            <td><?php echo htmlspecialchars($genre['ID_GENRE']); ?></td>
                            <td><?php echo htmlspecialchars($genre['NAME']); ?></td>
                            <td>
                                <a href="/genres/edit/<?php echo htmlspecialchars($genre['ID_GENRE']); ?>" class="btn btn-warning btn-sm">Editar</a>
                                <form action="/genres/delete/<?php echo htmlspecialchars($genre['ID_GENRE']); ?>" method="POST" style="display:inline;">
