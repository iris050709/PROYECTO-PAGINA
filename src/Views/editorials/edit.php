...
<div class="container mt-5">
    ...
    <?php endif; ?>
    <form action="/editorials/update/<?php echo htmlspecialchars($editorial['ISBN']); ?>" method="POST">
        <div class="mb-3">
            <label for="name" class="form-label">Nombre</label>
            <input type="text" class="form-control" id="name" name="name" value="<?php echo htmlspecialchars($editorial['NAME']); ?>" required>
        </div>
