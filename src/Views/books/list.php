                ...
                <tbody>
                    <?php foreach ($books as $book): ?>
                        <tr>
                            ...
                            <td>
                                <a href="/books/edit/<?php echo htmlspecialchars($book['ID_BOOK']); ?>" class="btn btn-warning btn-sm">Editar</a>
                                <form action="/books/delete/<?php echo htmlspecialchars($book['ID_BOOK']); ?>" method="POST" style="display:inline;">
